...
| `WG_CONF_TEMPLATE`            | The custom `wg.conf` config file template. Please refer to our [default template](https://github.com/ihzarfm/wireguard-ui/blob/master/templates/wg.conf)                                                                                                                        | N/A                                |
